...
class Drone:
    ...
    def execute(self, mission_or_action: Union['Mission', 'Action'], blocking: bool = True) -> Optional[threading.Thread]:
    ...
    def set_mode(self, mode: str) -> None:
        ...
        """
        log.info(f"Switching vehicle mode to: {mode}")
    ...
    def __repr__(self) -> str:
        return f"Drone(url={self.connector.url}, mode={self.state.vehicle_status.mode})"
