"""
DroneBlock Internal Event Bus Module.

Handles local asynchronous communication between all internal components.
"""
import logging
        ...
        if event_name in self._handlers:
            for handler in self._handlers[event_name]:
                try:
                    ...
                    log.error("Error in handler for '%s': %s", event_name, e, exc_info=True)
