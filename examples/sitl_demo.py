...
def main():
    ...
    drone.on(
        "vehicle_gps_position", lambda pos: print(f"Alt: {pos.alt_rel:.2f}m", end="\r")
    )
    ...
    mission = Mission(
        [
            ...
            Takeoff(5),
            Goto(
                drone.state.vehicle_gps_position.lat + 0.0001,
                drone.state.vehicle_gps_position.lon + 0.0001,
                5,
            ),
            Land(),
        ]
